                    ...
                    <div>
                      <div styleName="title">
                        <FormattedMessage
                          ...
                          values={{
                            reputation: <b>{Number.isInteger(reputation) ? reputation : '?'}</b>,
                          }}
                        />
                      </div>
                      <div styleName="currency">
                        <span>
                          {buyAmount.toFixed(5)} <span styleName="coin">{buyCurrency}</span>
                        </span>
                        <span styleName="arrow">
                          <img src={ArrowRightSvg} alt="" />
                        </span>
                        <span>
                          {sellAmount.toFixed(5)} <span styleName="coin">{sellCurrency}</span>
                        </span>
                      </div>
                    </div>
