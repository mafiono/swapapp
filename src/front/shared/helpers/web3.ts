...
let web3: EthereumProvider = new Web3(new Web3.providers.HttpProvider(config.web3.provider))
...
export { setMetamask, web3, getWeb3, setDefaultProvider, setProvider, getCurrentWeb3 }
