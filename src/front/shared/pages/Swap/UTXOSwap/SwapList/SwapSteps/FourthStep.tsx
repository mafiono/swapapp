...
const FourthStep = (props) => {
  const { isFourthStepActive, text } = props
  ...
  return (
    ...
    >
      ...
      <p id="swapCompleted" styleName="stepText">
        <FormattedMessage id="BtcToEthToken123" defaultMessage="The swap is finish!" />
      </p>
      {isFourthStepActive && <span styleName="stepHeading">{text}</span>}
    </div>
  )
}
