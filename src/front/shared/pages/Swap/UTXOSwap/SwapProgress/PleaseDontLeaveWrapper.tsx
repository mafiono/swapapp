  ...
  return (
    <Fragment>
      ...
      <div styleName="dontLeave">
        <FormattedMessage
          id="swapprogressDONTLEAVE"
          defaultMessage="Please do not leave this page "
        />
        <Tooltip id="swapjsdontleave" dontHideMobile={true}>
          <p>
            <FormattedMessage
              id="swapjsdontleave"
        ...
        {isBtcLike && (
          <strong styleName="saveSecretKey">
            <FormattedMessage
              id="swapprogressDONTLEAVEBTC"
              defaultMessage="Or save this SECRET before you leave:"
            />
