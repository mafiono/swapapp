...
import { testnet, mainnet } from './../simple/src/instances/ethereum'
...
export default {
  ...
  ethSwap: {
    ...
    fetchBalance: (address) => eth.testnet.fetchBalance(address),
  },
  btcSwap: {
  ...
  noxonTokenSwap: {
    ...
    abi: [
      ...
      {
        anonymous: false,
        inputs: [{ indexed: false, name: 'createdAt', type: 'uint256' }],
        name: 'CreateSwap',
        type: 'event',
      },
    ...
    tokenAbi: [
      ...
      { payable: true, stateMutability: 'payable', type: 'fallback' },
      {
        ...
        inputs: [
          ...
          { indexed: false, name: 'ethers', type: 'uint256' },
          { indexed: false, name: '_emissionedPrice', type: 'uint256' },
          { indexed: false, name: 'amountOfTokens', type: 'uint256' },
        ],
        name: 'TokenBought',
        type: 'event',
      },
      {
        ...
        inputs: [
          { indexed: true, name: 'buyer', type: 'address' },
          { indexed: false, name: 'ethers', type: 'uint256' },
          { indexed: false, name: '_burnedPrice', type: 'uint256' },
          { indexed: false, name: 'amountOfTokens', type: 'uint256' },
        ],
        name: 'TokenBurned',
        type: 'event',
      ...
      {
        anonymous: false,
        inputs: [{ indexed: false, name: 'etherReserved', type: 'uint256' }],
        name: 'EtherReserved',
        type: 'event',
      },
      {
    ...
    decimals: NOXON.decimals,
    fetchBalance: (address) =>
      eth.testnet.fetchTokenBalance(address, NOXON.tokenAddress, NOXON.decimals),
  },
  swapTokenSwap: {
    name: 'SWAP',
    address: '0xBA5c6DC3CAcdE8EA754e47c817846f771944518F',
    ...
    fetchBalance: (address) =>
      eth.testnet.fetchTokenBalance(address, SWAP.tokenAddress, SWAP.decimals),
  },
}
